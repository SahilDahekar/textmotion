...
function GeneratePage() {
  ...
  async function handleGenerateAnimation(text: string) {
    ...
    setIsLoading(true)
    try {
      const genResponse = await axios.post("http://a0618efcd8e98474abb8f7492a7ea42f-237795218.ap-south-1.elb.amazonaws.com:5000/api/generate", { text });
      ...
      const payload: ExecutionRequest = {
        ...
        const execResponse = await axios.post("http://a0618efcd8e98474abb8f7492a7ea42f-237795218.ap-south-1.elb.amazonaws.com/api/execute", payload, {
        timeout: 10000 * 15,
      });
